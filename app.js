...
function createOrder(){
  ...
  const order={invoice:inv,service:state.service.name,icon:state.service.icon,package:packageName(state.service.name,state.package),qty:state.qty,total,date:state.date,time:state.time,name:state.name,phone:state.phone,address:state.address,status:"Menunggu Konfirmasi",createdAt:new Date().toISOString()};
  ...
  closeOrder();renderOrders();renderInvoice();showPage("pesanan");showToast("Pesanan berhasil dibuat");
}
