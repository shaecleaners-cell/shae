...
function showError(e) {
  ...
  const messages = {
    ...
    "auth/configuration-not-found": "Firebase Authentication belum dikonfigurasi. Aktifkan Email/Password di Firebase Console.",
    "auth/network-request-failed": "Koneksi internet bermasalah.",
    "auth/too-many-requests": "Terlalu banyak percobaan. Coba lagi beberapa saat."
  };
  msg.textContent = messages[e.code] || ("Terjadi kesalahan: " + (e.message || "tidak diketahui"));
}
...
if (registerForm) {
  registerForm.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      msg.textContent = "✓ Akun berhasil dibuat. Membuka aplikasi...";
